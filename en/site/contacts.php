...
<head>
    ...
    <title>NETEX 24 - Контакты</title>
    <meta name="csrf-param" content="_csrf-frontend">
    <meta name="csrf-token" content="1-Aq8Nx8nW7eItEPjF49_UCPmqyHUQhdaN1s-09PPp2tqlm3rTXMNpNDgku0BHuZN__CwtMUam4EsDuKLAhdyA==">
                        ...
                        <div class="col-md-12">
                            <div class="header__wrapper">
                                ...
                                <div class="menu">
                                    <ul class="menu-list">
                                        <li class="menu__item">
                                            <a class="menu__link" href="questions.php">Q&A</a>
                                        </li>

                                        <li class="menu__item">
                                            <a class="menu__link" href="../pages/rules.php">Rules</a>
                                        </li>

                                        <li class="menu__item">
                                            <a class="menu__link" href="contacts.php">Contact Us</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="contacts">
                                <ul class="contacts-list">
                                    <li class="contact-item">
                                        <a class="contact-link" href="https://t.me/Netex24_Support" target="_blank">
                                ...
                                <div class="contact-note">
                                    If something went wrong, for greater efficiency, write to us in telegram, the button for communication in the upper right part of the screen. Our experts will be happy to answer any of your questions. </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="footer-right">
                            <ul class="footer-menu">
                                <li>
                                    <a href="../pages/terms.php">Exchange terms</a>
                                </li>
